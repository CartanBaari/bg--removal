...
function Header() {
  ...
  return (
    <div className='flex items-center justify-between  max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-32 sm:mt-20'>
       {/*Left side-----------------------------------------------  */}
       <div>
        ...
        <div>
            <input onChange={e=>RemovalBG(e.target.files[0])} type='file' accept='image/*' id='upload1' hidden/>
